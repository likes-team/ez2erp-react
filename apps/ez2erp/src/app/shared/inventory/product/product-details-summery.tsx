...
import GetSize from '@/app/shared/inventory/product/get-size';
import { calculatePercentage } from '@core/utils/calculate-percentage';
import { GetColor } from '@/app/shared/inventory/product/get-color';
import WishlistButton from '@/app/shared/inventory/product/wishlist-button';
